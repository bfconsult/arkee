...
class InvitationController extends Controller
{
     ...
     * someone who may never use the app themselves, or just to get them
     * added before they get around to accepting an invite. "Send Invite"
     * (inviteMember, below) is an optional follow-up once they have an
     * email on file.
     */
